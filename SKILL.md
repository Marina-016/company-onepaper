...
- 每格只保留一句完整的最新业务进展，正文控制在 20–60 个汉字内；禁止硬截断或使用省略号。优先新品、产品结构、渠道、价格、产能、订单、客户导入、技术、组织改革和市占率。财务数据仅可作极短背景，不得成为主体；若材料没有明确业务事件，可基于该公司自身材料作克制的业务动向归纳并标注来源，不得虚构具体事实。
